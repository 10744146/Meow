...
<body>
<%           
	Integer amount=new Integer(Integer.valueOf(request.getParameter("proamount")));
...
//Step 4: 執行 SQL 指令	
           sql="insert shoppingcar(no,product, proPrice,amount,price,name) ";
           sql+="value ('" + no + "', ";
		   sql+="'"+product+"', ";  
           sql+="'"+proPrice+"', ";  
           sql+="'"+amount+"', ";		   
