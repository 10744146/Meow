	...
	try {
        ...
        try 
		{
			...
			else
			{
				...
				sql="UPDATE products SET proPrice='"+proPrice+"',proDis='"+proDis+"',proPic1='"+proPic1+"',proPic2='"+proPic2+"',proPic3='"+proPic3+"',proNote='"+proNote+"',stoNum='"+stoNum+"' WHERE proName='"+proName+"' ";
				con.createStatement().execute(sql);  
