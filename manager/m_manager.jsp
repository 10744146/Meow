		...
		<div class="container-fluid px-0">
			<div class="row">
				<div class="col-md-12">
					...
					<!-- Modal -->
					<form  name="form1" method="POST" action="newMan.jsp"  class="needs-validation" novalidate>
									...
									<div class="modal-body">
										<form>
											...
											<div class="form-group">
												...
												<small id="Help" class="form-text text-muted">(驗證碼正確才能進行修改，提示：Demo日)</small>
											</div>
										</div>
					...
					<!-- Modal2 -->
					<form  name="form1" method="POST" action="DelMan.jsp" class="needs-validation" novalidate>
					...
					<!-- Modal3 -->
					<form  name="form1" method="POST" action="changeMan.jsp" class="needs-validation" novalidate>
