...
<html lang="en">
	<head>
		...
		<title>訂貨</title>
		<script src="assets/js/order2.js"></script>
		<style>
	...
	<body>
		...
		<div class="container">
			...
			<div>
				<center><form action="function/changestock.jsp"><button type="submit" class="btn btn-info" onclick="sure()">確認</button></form></center>
			</div>
		</div><br>
