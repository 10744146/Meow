					...
					<h2>ALL &nbsp; PRODUCT</h2>
								...
								for(int i=0;i<n;i++ )
								{
									...
									while(rs.next()){
										...
										out.println("<a href='goods.jsp?page="+rs.getString("no")+"'><img src='"+rs.getString("proPic1")+"' class='card-img-top'></a>");
										out.println("<div class='card-body'>");
										out.println("<div style='float: right;'>");
										out.println("<a href='function/newLove.jsp?page="+rs.getString("no")+"'><img src='image/love1.png' style='width: 30px; height: 30px;'></a>");
										out.println("<a href='function/newCar.jsp?page="+rs.getString("no")+"'><img src='image/image3.png' style='width: 35px; height: 35px;'></a>");
										out.println("</div><br>");
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center">
								<br>
								<p>
									<img src="image/icon1.png">客服時間/週一~週五10:00-12:00，13:00~17:00<br>
									<img src="image/icon2.png">客服信箱/meow@gmail.com<br>
									<img src="image/icon3.png">客服電話/0800-056-868<br>
									Copyright &copy; 2019 All Rights Reserved Design By MEOW
								</p>
							</div>
						</div>
					</div>
